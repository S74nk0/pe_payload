...
void addPayload(std::istream& in_stream, std::istream& payload_stream, std::ostream& out_stream)
{
	...
	std::cout << "cert_table_offset: " << cert_table_offset << " || cert_table_length: " << cert_table_length << " || cert_table_length2: " << cert_table_length2 << std::endl;

	std::cout << "cert_table_length_offset: " << cert_table_length_offset << std::endl;
